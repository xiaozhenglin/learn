...
import com.chehaha.api.sms.chuanglan.request.SmsReportRequest;
import com.chehaha.api.sms.chuanglan.response.SmsReportResponse;
...
public class SmsReportDemo {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        String requestJson = FastjsonUtil.parse(smsReportRequest);
        ...
        SmsReportResponse smsReportRespnse = FastjsonUtil.toObject(response, SmsReportResponse.class);
