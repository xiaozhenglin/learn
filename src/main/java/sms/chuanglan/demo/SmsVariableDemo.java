...
import com.chehaha.api.sms.chuanglan.request.SmsVariableRequest;
import com.chehaha.api.sms.chuanglan.response.SmsVariableResponse;
...
public class SmsVariableDemo {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        String requestJson = FastjsonUtil.parse(smsVariableRequest);
		...
		SmsVariableResponse smsVariableResponse = FastjsonUtil.toObject(response, SmsVariableResponse.class);
