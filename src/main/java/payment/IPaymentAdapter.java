...
//	Serializable payOrder(OrderInfo order, PayApiType apiType, Object... extentions) throws BizException,FrameworkException;
	Serializable payOrder(IPayParam payParam) throws BizException,FrameworkException;
	 ...
	 * @throws FrameworkException
	 */
	Serializable refund(OrderInfo order,Serializable response,String reason) throws BizException,FrameworkException;
	 ...
	 * @throws FrameworkException
	 */
	void payCallback(Serializable  data, HttpServletRequest request) throws FrameworkException;
	 ...
	 * 转账
	 */
	Serializable transfer(ITransferParam transferParam) throws  FrameworkException;
}
