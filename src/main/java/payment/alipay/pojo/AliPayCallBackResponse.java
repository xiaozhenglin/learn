...
import com.chehaha.fee.entity.PaymentInfo;
 ...
 * <p>支付宝回调接口对象</p>
 * <p>参考自支付宝</p>
 * <url>https://docs.open.alipay.com/204/105301/</url>
 * Created by DK on 2017/12/19.
 */
public class AliPayCallBackResponse implements Serializable {

    private String notify_time;//   通知时间 Date 通知的发送时间。格式为yyyy-MM-dd HH:mm:ss
    ...
    private String passback_params;//回传参数     公共回传参数，如果请求时传递了该参数，则返回给商户时会在异步通知时将该参数原样返回。本参数必须进行UrlEncode之后才可以发送给支付宝
